...
urlpatterns = [
    ...
    path('place-entry/', place_bet, name='place_bet'),
    path('current-session/',view_bets_current_session, name='view_bets_current_session'),
    path('view-entry-history/',view_bets_history, name='view_bets_history'),
    path('my-entry/', user_bet_history, name='user-bet-history'),
    ...
    path('admin/entry/', admin_bet_records, name='admin_bet_records'),
    path('admin/undo-result/', undo_result, name='undo_result'),

    path('admin/redeem-requests/', admin_withdraw_requests, name='admin_withdraw_requests'),
    path('admin/redeem-action/', admin_withdraw_action, name='admin_withdraw_action'),
    path('admin/transactions/', admin_transactions, name='admin_transactions'),
    path('admin/coins-requests/', admin_list_deposit_requests, name='admin_list_deposit_requests'),
    path('admin/coins-action/', admin_deposit_action, name='admin_deposit_action'),
    ...
    path('result-history/', user_declare_result_history, name='user_declare_result_history'),
